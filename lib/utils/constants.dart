...
const TextTheme TEXT_THEME_DEFULT = TextTheme(
    headline1: TextStyle(
...
const TextTheme TEXT_THEME_SMALL = TextTheme(
    ...
    bodyText1: TextStyle(color: COLOR_BLACK,fontSize:12 ,fontWeight: FontWeight.w500,height: 1.0
    ),
    bodyText2: TextStyle(color: COLOR_GREY,fontSize:12,fontWeight: FontWeight.w500,height: 1.0
    ),
